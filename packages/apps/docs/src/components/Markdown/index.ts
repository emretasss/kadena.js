...
export type ExtendedIntrinsicElements = JSX.IntrinsicElements & {
  'kda-notification': React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
  'kda-youtube': React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
};

// eslint-disable-next-line @rushstack/no-new-null
type FunctionComponent<Props> = (props: Props) => JSX.Element | null;
export type MDXComponents = {
  [Key in keyof ExtendedIntrinsicElements]?: FunctionComponent<ExtendedIntrinsicElements[Key]>;
};
...
export const markDownComponents: MDXComponents = {
  ...
  blockquote: BlockQuote as FunctionComponent<ExtendedIntrinsicElements['blockquote']>,
  ...
  tbody: TableChildren.Body as FunctionComponent<ExtendedIntrinsicElements['tbody']>,
  thead: TableChildren.Head as FunctionComponent<ExtendedIntrinsicElements['thead']>,
  ...
  'kda-notification': MDNotification as FunctionComponent<ExtendedIntrinsicElements['kda-notification']>,
  'kda-youtube': Youtube as FunctionComponent<ExtendedIntrinsicElements['kda-youtube']>,
