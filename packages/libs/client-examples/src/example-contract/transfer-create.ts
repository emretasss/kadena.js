import { isSignedTransaction, Pact, readKeyset, signWithChainweaver } from '@kadena/client';
...
async function main(): Promise<void> {
  const senderAccount = 'k:dc20ab800b0420be9b1075c97e80b104b073b0405b5e2b78afd29dd74aaf5e46';
  const receiverAccount = 'k:1a98599ff4677a119565d852b29b0d447c5051cb2c49673c32cba3fae096e209';
  ...
  const transaction = Pact.builder
    .execution(Pact.modules.coin['transfer-create'](senderAccount, receiverAccount, readKeyset('ks'), amount))
