...
export const apiHostGenerator = ({ networkId, chainId }: { networkId: string; chainId: ChainId }): string => {
  switch (networkId) {
    case 'mainnet01':
...
export const { listen, submit, preflight, dirtyRead, pollCreateSpv, pollStatus, getStatus, createSpv } =
