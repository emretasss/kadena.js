...
export interface IButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'as' | 'disabled'> {
  as?: 'button' | 'a';
...
export const Button: FC<IButtonProps> = ({ as = 'button', icon, onClick, href, children, ...props }) => {
  const Icon = icon;
