...
export interface IWrappedData<T extends any = any, N extends string | undefined = string | undefined> {
  name: N;
  inspect: true;
  data: T;
}

export type ExWrappedData<T extends any, N extends string | undefined> = T extends IWrappedData
...
export interface IWrapData {
  <T, N extends string | undefined = undefined>(value: T, name?: N): ExWrappedData<T, N>;
}
