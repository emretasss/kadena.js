...
const meta: Meta<{ selectIcon: keyof typeof ProductIcon } & ITrackerCardProps> = {
  ...
  argTypes: {
    ...
    selectIcon: {
      options: [undefined, ...(Object.keys(ProductIcon) as (keyof typeof ProductIcon)[])],
      control: {
        type: 'select',
      },
    },
...
type Story = StoryObj<{ selectIcon: keyof typeof ProductIcon } & ITrackerCardProps>;
...
export const Primary: Story = {
  ...
  render: ({ labelValues, helperText, helperTextType, selectIcon, variant }) => {
